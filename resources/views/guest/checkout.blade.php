                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="wide w-100" id="state">
                                        ...
                                        <option value="Chose..." data-display="Select">Choose...</option>
            ...
            fetch('/address/province')
                ...
                .then((data) => {
                    ...
                    data.data.forEach((item) => {
                        console.log(item.ProvinceID, item.ProvinceName);
                    ...
                    selectCountry.addEventListener('change', function () {
                        ...
                        fetch('/address/district/' + provinceId)
                            ...
                            .then((data) => {
                                ...
                                elmState.innerHTML = ''; // Xóa các tùy chọn cũ
                                data.data.forEach((item) => {
                                    const option = document.createElement('option');
                    ...
                    const selectWard = document.querySelector('#state');
                    selectWard.addEventListener('change', function () {
                        ...
                        fetch('/address/ward/' + districtId)
                            ...
                            .then((data) => {
                                ...
                                elmWard.innerHTML = ''; // Xóa các tùy chọn cũ
                                data.data.forEach((item) => {
                                    const option = document.createElement('option');
